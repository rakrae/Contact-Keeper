...
public class DatabaseCreator {
	...
	public static void insertDummyData() {
		...
		Contact ct = new Contact(0l, "Mickey", "Mouse", "Disney Street", 787878787, "MickeyMouse@blabla.com", "Mickey", "Mickey the Mouse", "MK");
		Account ac = new Account(0l,"Rakrae", "123", "Adi Andrei", "Bihuneti", "M", 29, ct);
